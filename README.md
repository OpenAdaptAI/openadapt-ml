...
**Cost/Latency Comparison (SoM mode, synthetic benchmarks only):**

| Approach | Login Accuracy | Registration Accuracy | Cost | Latency |
|----------|----------------|----------------------|------|---------|
| Claude API + SoM | 100%* | TBD | ~$0.01/step | ~500ms |
| GPT-4.1 API + SoM | 100%* | TBD | ~$0.01/step | ~500ms |
| **Qwen 2B + SoM** | **100%** | **100%** | **Free (local)** | **~50ms** |

*API results are preliminary and pending full evaluation. These numbers are on synthetic benchmarks with 3-6 UI elements - real-world performance will differ.
